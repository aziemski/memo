            ...
            <form id="form" action="{{ route('signup') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <span class="input-group-text" id="name-addon">
                        ...
                        <input type="text" name="name" id="name-input" placeholder="Name" class="form-control" required
                ...
                <div class="mb-3">
                    ...
                    <span class="input-group-text" id="repeat-password-addon">
                        ...
                        <input type="password" name="password_confirmation" id="repeat-password-input"
