    ...
    <div class="container m-5">
        ...
        <form action="{{ route('events.update', $event->id) }}" method="POST" class="border p-4 rounded bg-light">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $event->name) }}" class="form-control" required>
            </div>

            <div class="mb-3">
                <label for="start_date" class="form-label">Start Date:</label>
                <input type="date" id="start_date" name="start_date" value="{{ old('start_date', $event->start_date) }}" class="form-control" required>
            </div>

            <div class="mb-3">
                <label for="end_date" class="form-label">End Date:</label>
                <input type="date" id="end_date" name="end_date" value="{{ old('end_date', $event->end_date) }}" class="form-control" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="url" id="image_url" name="image_url" value="{{ old('image_url', $event->image_url) }}" class="form-control">
            </div>
